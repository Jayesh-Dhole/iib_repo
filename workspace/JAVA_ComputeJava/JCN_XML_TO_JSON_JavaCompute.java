...
public class JCN_XML_TO_JSON_JavaCompute extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			MbElement Loc = inputroot.getFirstElementByPath("XMLNSC/Student/Loc");
		    ...
		    MbElement resp = Data.createElementAsLastChild(MbJSON.OBJECT, "Student", null);

		    // map the values to output root 
			resp.createElementAsLastChild(MbElement.TYPE_NAME_VALUE,"Student_Name",Name.getValue());
			resp.createElementAsLastChild(MbElement.TYPE_NAME_VALUE,"Student_Id",Id.getValue());
			resp.createElementAsLastChild(MbElement.TYPE_NAME_VALUE,"Student_Loc",Loc.getValue());
